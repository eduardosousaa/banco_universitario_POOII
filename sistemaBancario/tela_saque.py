...
class Tela_Saque(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_nomeTelaSaque.setGeometry(QtCore.QRect(260, 40, 181, 51))
        font = QtGui.QFont()
...
"")
        ...
        self.frame.setGeometry(QtCore.QRect(130, 130, 411, 281))
        ...
        self.btn_sacar.setGeometry(QtCore.QRect(170, 190, 101, 31))
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.txt_valorSaque = QtWidgets.QLineEdit(self.frame)
        self.txt_valorSaque.setGeometry(QtCore.QRect(90, 80, 261, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.txt_valorSaque.setFont(font)
        self.txt_valorSaque.setStyleSheet("color: rgb(255, 255, 255);")
        self.txt_valorSaque.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_valorSaque.setObjectName("txt_valorSaque")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txt_nomeTelaSaque.setText(_translate("MainWindow", "Tela de Saque"))
        ...
        self.txt_valorSaque.setPlaceholderText(_translate("MainWindow", "R$ Valor do saque"))
